...
|--|--|--|--|--|--|
|[replit](https://replit.com/)|![Active](https://img.shields.io/badge/Active-brightgreen)|◼️|☑️|[FreeGPT WebUI](https://replit.com/@DmitryParamono1/FreeGPT)|[Chat](https://replit.com/@DmitryParamono1/FreeGPT/)
...
```
git clone https://github.com/io112/FreeGPT.git
```
